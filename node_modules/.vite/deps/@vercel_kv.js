...
var require_chunk_SMBYCQIJ = __commonJS({
  "node_modules/@upstash/redis/chunk-SMBYCQIJ.js"(exports) {
    "use strict";
    ...
    function xe(s) {
      let n = [];
      for (let t of s) !_optionalChain([t, "optionalAccess", (_20) => _20[0]]) || !_optionalChain([t, "optionalAccess", (_21) => _21[1]]) || n.push({ lng: parseFloat(t[0]), lat: parseFloat(t[1]) });
      return n;
    }
...
var require_nodejs = __commonJS({
  "node_modules/@upstash/redis/nodejs.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function _optionalChain(ops) {
      let lastAccessLHS = void 0;
    ...
    var a = class n extends _chunkSMBYCQIJjs.b {
      ...
      static fromEnv(e) {
        if (typeof _optionalChain([process, "optionalAccess", (_) => _.env]) > "u") throw new Error('Unable to get environment variables, `process.env` is undefined. If you are deploying to cloudflare, please import from "@upstash/redis/cloudflare" instead');
...
var import_redis = __toESM(require_nodejs());
var _kv = null;
